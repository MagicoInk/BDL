...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Sí, con cita. Conoces padres, espacios y proceso de crianza.',
  },
  {
  ...
  return (
    <section id="faq" className="bg-fw-bg-soft px-5 py-20 lg:px-10 lg:py-28">
      <div className="mx-auto max-w-3xl">
        ...
        >
          <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.3em] text-fw-gold">FAQ</p>
        ...
        <Accordion type="single" collapsible className="space-y-0">
          {faqs.map((faq, idx) => (
            ...
            >
              <AccordionTrigger className="py-5 text-left text-base font-semibold text-fw-fog hover:no-underline hover:text-fw-gold data-[state=open]:text-fw-gold">
                {faq.question}
              </AccordionTrigger>
        ...
        >
          <a
            ...
            className="inline-flex rounded-full border border-fw-gold px-8 py-3 text-xs font-bold uppercase tracking-[0.2em] text-fw-gold transition-colors hover:bg-fw-gold hover:text-fw-bg"
          >
